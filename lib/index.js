...
const { bundleComponentStylesheet } = require('@angular-devkit/build-angular/src/tools/esbuild/stylesheets/bundle-options');
const { SourceFileCache } = require('@angular-devkit/build-angular/src/tools/esbuild/angular/compiler-plugin');
const { AotCompilation } = require('@angular-devkit/build-angular/src/tools/esbuild/angular/aot-compilation');
const { convertTypeScriptDiagnostic } = require('@angular-devkit/build-angular/src/tools/esbuild/angular/diagnostics');
const { JavaScriptTransformer } = require('@angular-devkit/build-angular/src/tools/esbuild/javascript-transformer');
